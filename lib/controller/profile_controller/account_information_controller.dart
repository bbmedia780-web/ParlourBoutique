...
class AccountInformationController extends GetxController {
  ...
  void _bindUserData() {
    ...
    ever(auth.userDob, (_) {dateOfBirthController.text = auth.userDob.isNotEmpty ? auth.userDob.value : formatDate(DateTime.now());});
    ...
    dateOfBirthController.text = auth.userDob.isNotEmpty ? auth.userDob.value : formatDate(DateTime.now());
