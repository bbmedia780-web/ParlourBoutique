...
import '../view/screen/profile_screen/profile_page_screen.dart';
...
/// App Routes - All bindings are handled in AppBinding
/// No individual route bindings needed
class AppRoutes {
  // Route Names
  ...
  // Route Pages - All controllers initialized in AppBinding
  static final routes = [
    GetPage(name: splash, page: () => const SplashScreen(), transition: Transition.cupertino),
    ...
    GetPage(name: details, page: () => DetailsScreen(), transition: Transition.cupertino),
    ...
    GetPage(name: addRentProduct, page: () => AddRentProductScreen(), transition: Transition.cupertino),
    GetPage(name: uploadCreation, page: () => UploadCreationScreen(), transition: Transition.cupertino),
