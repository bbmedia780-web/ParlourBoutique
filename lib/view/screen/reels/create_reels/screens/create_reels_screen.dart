...
import 'package:parlour_app/constants/int_extensions.dart';
            ...
            child: Obx(() {
              ...
              return GalleryMediaPicker(
                ...
                pathList: (paths) {
                  ...
                  gridViewBgColor: AppColors.black,
                        albumTextColor: Colors.white,
                        gridPadding: EdgeInsets.zero,
                  thumbnailBgColor: AppColors.grey.withValues(alpha: 0.9),
                        thumbnailBoxFix: BoxFit.cover,
                        selectedAlbumIcon: Icons.check,
                  selectedCheckColor: AppColors.white,
                  albumSelectIconColor: AppColors.white,
                  selectedCheckBgColor: AppColors.primary,
                  selectedAlbumBgColor: AppColors.black,
                  albumDropDownBgColor: AppColors.white,
                  albumSelectTextColor: AppColors.white,
                        selectedAssetBgColor: AppColors.primary,
        ...
        children: [
          GestureDetector(
            ...
            child: CircleAvatar(
              ...
              child: Center(child: Icon(Icons.arrow_forward, color: AppColors.primary)),
            ),
          ),
          10.width,
        ],
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                _buildEditTool(
                                  icon: AppAssets.textIcon,
                                  label: 'Text',
                                  onTap: () => _showTextEditor(controller),
                                ),
                                _buildEditTool(
                                  icon: AppAssets.imageFilterIcon,
                                  label: 'Filter',
                                  onTap: () =>
                                      _showFilterBottomSheet(controller),
                                ),
                                _buildEditTool(
                                  icon: AppAssets.trimIcon,
                                  label: 'Trim',
                                  onTap: () =>
  ...
  void _showCameraOptions(CreateReelsController controller) {
    showDialog(context: context, builder: (context){
      return  AlertDialog(
        ...
        title: Text('Select Option', style: TextStyle(color: AppColors.white)),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            ListTile(
              leading: Icon(Icons.videocam, color: AppColors.white),
              title: Text('Record Video', style: TextStyle(color: AppColors.white)),
              onTap: () {
                Get.back();
            ...
            ListTile(
              ...
              title: Text('Take Photo', style: TextStyle(color: AppColors.white)),
              onTap: () {
                Get.back();
