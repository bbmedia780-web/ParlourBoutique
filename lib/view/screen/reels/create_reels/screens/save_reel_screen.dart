      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text('Use Default', style: TextStyle(color: AppColors.primary)),
          ),
        ],
      ),
    );
            ...
            return SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  //     },
                  //     icon: Icon(Icons.edit, color: AppColors.white, size: 18),
                  //     label: Text(
                  //       'Edit cover',
                  //       style: TextStyle(
                  //         color: AppColors.white,
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Icon(Icons.tag, color: AppColors.white, size: 14),
                              8.width,
                              Text(
                                'Hashtags',
                                style: AppTextStyles.subHeading.copyWith(
