          ...
          children: [
            Column(
              children: [
                ...
                //                 borderRadius: BorderRadius.circular(8),
                //               ),
                //               child: Icon(Icons.music_note, color: AppColors.white),
                //             ),
                //             12.width,
                //             Expanded(
                //               child: Column(
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                            image: AssetImage(
                                              music['image'] ?? AppAssets.boutique1,
                                            ),
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                        ...
                        IconButton(
                          icon: CircleAvatar(
                            ...
                            child: Padding(
                              ...
                              child: Image.asset(AppAssets.arrowRightIcon),
                            ),
                          ),
                          onPressed: () async {
  ...
  Widget _buildCategoryTab(String label, bool isSelected, VoidCallback onTap) {
    return GestureDetector(
      ...
      child: Container(
        padding: EdgeInsets.symmetric(horizontal: 16, vertical: 8),
        decoration: BoxDecoration(
          color: isSelected ? AppColors.white : Color(0xff27282d),
