  ...
  Widget _buildMainToolbar() {
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: AppColors.greyBgColor.withValues(alpha: 0.8),
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              // Font style (Aa)
              _buildToolbarIcon(
                imagePath: AppAssets.fontAdjustmentIcon,
                label: 'Aa',
              ...
              _buildToolbarIcon(
                ...
                isColor: false,
                imagePath: AppAssets.colorPlatIcon,
                label: '',
              ...
              _buildToolbarIcon(
                imagePath: AppAssets.textEditIcon,
                label: '///A',
              ...
              // Menu (alignment)
              _buildToolbarIcon(
                imagePath: AppAssets.textAlignIcon,
                label: '',
              ...
              _buildToolbarIcon(
                imagePath: AppAssets.textBgFillIcon,
                label: 'A',
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: isSelected ? AppColors.white : AppColors.black.withValues(alpha: 0.1),
      ...
      decoration: BoxDecoration(
            ...
            child: Row(
              ...
              color: Colors.grey[700],
                  ...
                  child: Icon(Icons.colorize, color: AppColors.white, size: 20),
                ),
                12.width,
                // Color squares
                Expanded(
  ...
  Widget _buildToolbarIcon({
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected?AppColors.grey575654Color:null,
          borderRadius: BorderRadius.circular(8),
        ),
        child: Center(
          child: imagePath != null
              ? SizedBox(
                  ...
                  child: Image.asset(
                    imagePath,
                    color: !isColor?null: AppColors.white,
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(icon, color: isSelected?AppColors.black:AppColors.white, size: 18),
            4.width,
            Text(
              label,
